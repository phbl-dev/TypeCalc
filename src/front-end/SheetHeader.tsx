...
export const SheetHeader: React.FC = () => {
    ...
    return (
        <header>
            <button className="menuButton" type="reset" id="reset">Clear</button>
            <div className="dropdown">
                <button className="dropbtn">Export</button>
                <div className="dropdown-content">
                    <button className="dropdownOption" id="xmlExport">XML</button>
                    <button className="dropdownOption" id="csvExport">CSV</button>
                </div>
            </div>

            <button className="menuButton" type="button" id="jumpToCell">Go to</button>
            <label htmlFor="cellIdInput"></label><input className="menuTextField" type="text" id="cellIdInput"/>
            <button className="styleButton" type="button" id="bold">B</button>
            <button className="styleButton" type="button" id="italic">I</button>
            <button className="styleButton" type="button" id="underline">U</button>
            <div id="cellColor">
                <label htmlFor="cellColorPicker" className="colorLabel">Cell</label>
                <input className="color" type="color" id="cellColorPicker" value="#000000"/>
            </div>
            <div id="textColor">
                <label htmlFor="textColorPicker" className="colorLabel">Text</label>
