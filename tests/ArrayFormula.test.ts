...
describe("ArrayFormula", () => {
    ...
    beforeEach(() => {
        ...
        funCall = FunCall.Make("FREQUENCY", [
            cellArea,
            ExprArray.MakeExprArray([new NumberConst(2), new NumberConst(4)]),
        ]); // Creating a function call to FREQUENCY
    ...
    test("constructor and eval", () => {
        ...
        let cachedArrayFormula = new CachedArrayFormula(
            ...
            sheet, // The sheet
            0,
            3, // Formula position (col=0, row=3) - A4
